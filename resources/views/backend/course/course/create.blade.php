    ...
    <div class="card">
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="course_title" class="form-control focuas_out_change" id="BlogTitle" placeholder="Enter Title" required>
            </div>
            <div class="form-group">
                <label for="description">{{ __("dashboard.description") }}</label>
                <textarea name="course_description" id="description"class="focuas_out_change" cols="30" rows="10"></textarea>
            </div>
                    ...
                    <div class="tab-pane text-left fade show active" id="vert-tabs-home" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="course_image" class="custom-file-input" id="courseImage">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="text" name="course_video" class="form-control" id="exampleInputFile">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row" id="pricesection">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="text" name="price" class="form-control" id="exampleInputFile">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="text" name="discount_price" class="form-control" id="exampleInputFile">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="meta_title">{{ __("dashboard.topic_title") }}</label>
                        <input type="text" name="title" class="form-control" id="topic_title" placeholder="Edit Topic Title">
                        <div class="tp-educal-feedback d-flex mt-10">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                <path d="M8.5 16C12.6421 16 16 12.6421 16 8.5C16 4.35786 12.6421 1 8.5 1C4.35786 1 1 4.35786 1 8.5C1 12.6421 4.35786 16 8.5 16Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
<script>
    ...
    $(document).ready(function () {
        ...
        window.onbeforeunload = function() {
            return "{{ __('dashboard.are_you_sure_to_leave_this_page') }}";
        }
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data.status == "success"){
                        course_id = data.id;
                        $("#course-form").attr("action",`{{ url('/admin/course/make/update') }}/${data.id}`);

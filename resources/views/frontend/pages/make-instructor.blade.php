           ...
           <div class="row">
              <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
                 <div class="section__title-wrapper section-padding mb-60 text-center">
                    <h2 class="section__title">Why an <span class="yellow-bg">scholercity <img src="{{ asset('frontend') }}/assets/img/shape/yellow-bg-2.png" alt=""></span> out of The ordinary</h2>
